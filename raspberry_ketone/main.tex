    ...
    \begin{itemize}
        ...
        \item Target Molecule: 4-(4-methoxyphenyl)butan-2-one (Anisylacetone).
            \begin{center}
                ...
                \caption{Target Analogue: Anisylacetone}
            \end{center}
...
\begin{frame}{Comparison: Analogue vs. Raspberry Ketone}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{lcc}
            ...
            \midrule
            Structure & \chemfig{**6(---(-[:90]OH)-=-(-[:330]R)-=)} & \chemfig{**6(---(-[:90]OCH_3)-=-(-[:330]R)-=)} \\
                      & (R = CH$_2$CH$_2$COCH$_3$) & (R = CH$_2$CH$_2$COCH$_3$) \\
